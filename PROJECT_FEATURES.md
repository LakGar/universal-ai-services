...
- **Buy Page** with categorized product listings
  ...
  - Product cards with images, pricing, and quick view
...
- **Product Detail Pages**
  - Image/video galleries with navigation
  - Multiple product configurations
  - Add-on selection system with pre-selected options
...
- **Wishlist**
  ...
  - Wishlist icon with count indicator
...
- **Event Detail Pages**
  ...
  - Host and speaker profiles with overlapping avatars
...
- **Multi-step Checkout Process**
  ...
  - Auto-fill city, postal code, and country
...
- **Custom Components**
  - Product cards
  - Event cards
  - Robot cards (desktop and mobile)
  - Image carousels with video support
  - Tabs component
  - Tooltips
  - Modals (consultation, contact)
  - Accordions
  - Badges
...
- Product Detail Pages (multiple)
- Event Listings Page
- Event Detail Pages (multiple)
- Checkout Page
- About Page
- Services Pages
